# Especificacao Tecnica — Dependency Injection

| Campo | Valor |
|---|---|
| Repositorio | `dependency_injection_project` |
| Linguagem | C (C / CMake) |
| Versao | 1.0 |
| Status | Ativo |
...
Exemplo de injecao de dependencia e inversao de controle. Este documento descreve requisitos, arquitetura e criterios de aceite.
...
Segue o scaffold idiomatico de C: codigo-fonte, testes e manifesto de build
...
- [ ] `cmake -B build && cmake --build build` conclui sem erros.
- [ ] `./build/app` executa o componente.
- [ ] `ctest --test-dir build` passa (CI verde, cobertura 100%).
